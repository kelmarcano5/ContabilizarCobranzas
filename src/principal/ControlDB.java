...
public class ControlDB extends ConexionDB{
	...
	public ResultSet consultarCobranzas()
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
		...
		try {
			sql="SELECT "
					...
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_entidad_rf, "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_sucursal_rf, "
					...
					+ "case when smn_cobranzas.smn_mov_documento_cob_cab.smn_moneda_rf is null then 0 else smn_cobranzas.smn_mov_documento_cob_cab.smn_moneda_rf end, "
					+ "Sum(smn_cobranzas.smn_mov_documento_cob_cab.mdc_monto_ml) AS total_monto_cobranzas_ml, "
					+ "Sum(smn_cobranzas.smn_mov_documento_cob_cab.mdc_monto_ma) AS total_monto_cobranzas_ma, "
					...
					+ "INNER JOIN smn_cobranzas.smn_documento ON smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_id = smn_cobranzas.smn_documento.smn_documento_id "
					+ "INNER JOIN smn_cont_financiera.smn_rel_modulo_documento_tipo_doc ON smn_cobranzas.smn_documento.smn_documento_general_rf = smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_documentos_generales_rf "
					...
					+ "WHERE "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.mdc_fecha_registro < current_date  "
					+ "AND "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.mdc_estatus_proceso = 'GE'  "
					+ "GROUP BY "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.mdc_fecha_registro, "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_id, "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_rf, "
					...
					+ "smn_cobranzas.smn_documento.doc_descripcion "
					+ "ORDER BY "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.mdc_fecha_registro ASC ";
	...
	public void updateCobranzasCabecera(int smn_entidad_rf, int smn_sucursal_rf, int smn_documento_id, int smn_moneda_rf, Date mdc_fecha_registro, int smn_control_cierre_contable_id)
	{
    	String sql;
    	PreparedStatement stmt;
    	
		try {	
			sql="UPDATE smn_cobranzas.smn_mov_documento_cob_cab SET "
			...
			stmt.setDate(6, mdc_fecha_registro);
			stmt.executeUpdate();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public ResultSet moduloCobranzas()
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
	...
	public ResultSet tipoDocumento(int smn_modulo_rf, int smn_documentos_generales_rf)
	{
    	...
    	System.out.println(smn_modulo_rf);
    	System.out.println(smn_documentos_generales_rf);
	...
	public ResultSet consultarDetalles(int smn_entidad_rf, int smn_sucursal_rf, int smn_documento_id, int smn_moneda_rf, Date fca_fecha_registro)
	{
		...
		try {
			sql="SELECT "
					...
					+ "case when smn_cobranzas.smn_mov_documento_cob_detalle.smn_moneda_rf is null then 0 else smn_cobranzas.smn_mov_documento_cob_detalle.smn_moneda_rf end, "
					...
					+ "INNER JOIN smn_cobranzas.smn_mov_documento_cob_cab ON smn_cobranzas.smn_mov_documento_cob_detalle.smn_mov_documento_cob_cab_id = smn_cobranzas.smn_mov_documento_cob_cab.smn_mov_documento_cob_cab_id and smn_cobranzas.smn_mov_documento_cob_cab.smn_cliente_rf  = smn_cobranzas.smn_mov_documento_cob_detalle.smn_cliente_rf "
					+ "INNER JOIN smn_cobranzas.smn_documento ON smn_cobranzas.smn_mov_documento_cob_detalle.smn_documento_id = smn_cobranzas.smn_documento.smn_documento_id "
					+ "INNER JOIN smn_base.smn_auxiliar ON smn_comercial.smn_cliente.smn_auxiliar_rf = smn_base.smn_auxiliar.smn_auxiliar_id "
					+ "WHERE "
					+ "smn_cobranzas.smn_mov_documento_cob_detalle.mdd_fecha_registro='"+fca_fecha_registro+"' "
					//+ " AND "
					//+ "smn_cobranzas.smn_mov_documento_cob_cab.mdc_estatus_proceso = 'GE' " 
					+ " AND "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_entidad_rf="+smn_entidad_rf
					+ " AND "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_sucursal_rf="+smn_sucursal_rf
					+ " AND "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_id="+smn_documento_id
					//+ "smn_cobranzas.smn_mov_documento_cob_detalle.smn_documento_id="+smn_documento_id
					+ " AND "
					+ "smn_cobranzas.smn_mov_documento_cob_detalle.smn_moneda_rf="+smn_moneda_rf+" "
					+ "ORDER BY "
					+ "smn_cobranzas.smn_mov_documento_cob_detalle.mdd_fecha_registro ASC, "
					+ "smn_cobranzas.smn_mov_documento_cob_detalle.smn_tipo_documento_id ASC, "
					+ "smn_cobranzas.smn_mov_documento_cob_cab.smn_documento_rf ASC ";
					System.out.println(sql);
			stmt = this.cn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
			rs=stmt.executeQuery(sql);
		} catch (SQLException e) {
	...
	public ResultSet consultarDiccionario()
	{
		...
		try {
			...
			sql="SELECT smn_diccionario_id "
			  ...
			  + "WHERE "
			  + "dic_esquema='smn_cobranza' "
			  + "AND "
			  + "dic_codigo='COB_05' ";
			  //+ "(dic_tabla='smn_cobranza') ";
			  //+ "AND "
			  //+ "dic_campo='"+campo+"'";
			System.out.println(sql);
			stmt = this.cn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
	...
	public ResultSet consultarDiccionario3()
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
	...
	public ResultSet consultarComponente(int smn_codigo_impuesto_rf)
	{
		...
		try {
			sql="SELECT "
			  ...
			  + "WHERE "
			  + "smn_componentes_id="+smn_codigo_impuesto_rf;
	...
	public void updateCobranzas(String fca_estatus_proceso, int smn_entidad_rf, int smn_sucursal_rf,
